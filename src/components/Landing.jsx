...
const LandingPage = () => {
  ...
  return (
      <>
        ...
        >
            <Nav>
                <Nav.Link onClick={handleSignupShow} className="me-3">
                    Signup
                </Nav.Link>
                <Nav.Link onClick={handleLoginShow} className="me-3">
                    Login
                </Nav.Link>
              ...
              >
                  ...
                  <Row className="mt-4">
                      ...
                      <Col md={4}>
                          ...
                          <p>
                              Use our tools to invest in stocks with high growth
                              potential.
                          </p>
                      </Col>
                      <Col md={4}>
                      ...
                      <Row>
                          <Col md={6}>
                              ...
                              <p>
                                  ...
                                  should be accessible to everyone. Our mission
                                  is to provide traders with the tools and
                                  knowledge they need to succeed in a fast-paced
                                  market. Whether you're a beginner or a
                                  seasoned professional, we have something for
                                  you.
                              </p>
                          </Col>
                          <Col md={6}>
                          ...
                          <Col md={4}>
                              <Card className="mb-4 service-card">
                                  <Card.Body>
                                      ...
                                      <Card.Text>
                                          Get personalized mentorship to refine
                          ...
                          <Col md={4}>
                              <Card className="mb-4 service-card">
                                  <Card.Body>
                                      ...
                                      <Card.Text>
                                          Our team is here to help you at every
                          ...
                          <Col md={4}>
                              <Card className="mb-4 service-card">
                                  <Card.Body>
                                      <img src={Bckimage} />
                                      <Card.Text>
                                          "I started trading with no experience,
                                          but with Trade Tavern's guidance, I
                                          feel confident in my trades every
                                          day."
                                      </Card.Text>

...
const TopCompanies = () => {
  return (
    <Container className="mt-4 scroll-container" style={{ maxWidth: '350px', overflowY: 'auto', height: '541px',borderRadius: '15px', backgroundColor:'lavender',marginRight:'10px'}}>
